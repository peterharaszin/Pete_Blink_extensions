...
chrome.extension.sendMessage({}, function(response) {
  var readyStateCheckInterval = setInterval(function() {
    if (document.readyState === "complete") {
      ...
      console.log("Hello. This message was sent from scripts/forum_mod.js");
      // ----------------------------------------------------------
      ...
      var toUsernameInputElement = document.createElement("div");
      toUsernameInputElement.className = "text username-wrapper username-wrapper-to";
      toUsernameInputElement.innerHTML =
              '<label>'
      ...
      searchFormElement.insertBefore(toUsernameInputElement, fromUsernameInputElement.nextSibling);
